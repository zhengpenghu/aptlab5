 ...
 */
public class UserProgram_Utilties extends Quotes {
    ...
    public UserProgram_Utilties(String symbol) throws Exception {
        super(symbol);
    }
    ...
    public String getGoogleChartFormattedData(int interval) {
